#!/bin/bash
# AgentFlow top-8 evaluation script.
...
OUTPUT=${OUTPUT:-"$(dirname "$0")/eval_top8_results.json"}
...
echo "▶ 开始 top-${SAMPLES_PER_PROMPT} 评估..."
echo "  模型       : ${MODEL_PATH}"
...
echo ""
echo "✓ top-${SAMPLES_PER_PROMPT} 评估完成，结果保存至：${OUTPUT}"
